...
import ProductSlider2 from "./slider/Slider3";
  ...
  return (
    <>
      <VStack mt={6} align="center">
        ...
        <Heading as="p" size="sm" color="gray">
          Freshest meats just for you
        </Heading>
        <VStack>
          <SimpleGrid columns={{ base: 2, md: 6 }} spacing={12} width="80%">
            <Box>
              ...
              <Heading as="p" size="xs" color="blackAlpha.800">
                Todays Deals
              </Heading>
            </Box>
            <Box>
          ...
          <Box width="85%" marginLeft="8rem" textAlign="center">
            <Image
      ...
      <Heading as="p" size="sm" color="gray" p={2}>
        Handpicked assortment just for you
      </Heading>
    
      <Box  display={{ base: 'block', md: 'flex' }}
  justifyContent={{ base: 'center', md: 'space-between' }}
  width={{ base: '100%', md: '700px' }}   mr="auto" ml={{base:"100px",md:"auto"}}>
        <Box pb={3}>
          <img
            style={{ borderRadius: "20px" }}
            width="200px"
            src="https://dao54xqhg9jfa.cloudfront.net/oms/8afb0054-9ca3-2cd1-5951-68ea99d69923/original/Meaty_Bites_copy-4.jpeg"
            alt=""
          />
        </Box>
        <Box pb={3}>
          <img
            style={{ borderRadius: "20px" }}
            width="200px"
            src="https://dao54xqhg9jfa.cloudfront.net/oms/91af480b-5514-f257-f46d-fac389ec70d9/original/Mutton_Delights_copy_2-3.jpeg"
            alt="mutton"
          />
        </Box>
        <Box >
          <img
            style={{ borderRadius: "20px" }}
            width="200px"
            src="https://dao54xqhg9jfa.cloudfront.net/oms/8b097972-68f4-70bf-c4b2-3922b60852eb/original/DFD_New.jpeg"
            alt="fish"
          />
        </Box>
      </Box>
      ...
      <Box ml="auto" mr="auto">
        <Image
          src="https://www.licious.in/image/rebranding/svg/meatopia_join_now_desktop.svg"
          alt="food"
        />
      </Box>
      <ProductSlider2 />
      <Box display="flex" bg="pink.100" flexDirection="column" alignItems="center">
        <Container maxW="2xl" centerContent>
          <Box padding="4" color="black" maxW="md" textAlign="center">
        ...
        <Container maxW="2xl" centerContent>
          <Box padding="4" color="black" textAlign="center">
